...
DEFAULT_STAGES: list[dict[str, Any]] = [
    ...
    {"id": "operator_case_slice", "requires": ["verified_foundation"],
     "files": ["tools/case_preview.py", "docs/capabilities/PROCESSOR_MATRIX.md", "tests/test_case_preview.py"],
     "build": [],
     "checks": [["{python}", "-m", "unittest", "discover", "-s", "tests", "-p", "test_case_preview.py", "-q"]],
     "gate": "Read-only matrix Case preview and verified Capability Card; canonical Case still pending."},
